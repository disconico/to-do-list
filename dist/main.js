...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ../src/assets/fonts/San Francisco Regular.ttf */ "./src/assets/fonts/San Francisco Regular.ttf"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ../src/assets/fonts/San Francisco Bold.ttf */ "./src/assets/fonts/San Francisco Bold.ttf"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(/*! ../src/assets/fonts/Pacifico-Regular.ttf */ "./src/assets/fonts/Pacifico-Regular.ttf"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_3___ = new URL(/* asset import */ __webpack_require__(/*! ../src/assets/images/remove.png */ "./src/assets/images/remove.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_4___ = new URL(/* asset import */ __webpack_require__(/*! ../src/assets/images/trash.png */ "./src/assets/images/trash.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_5___ = new URL(/* asset import */ __webpack_require__(/*! ../src/assets/images/edit.png */ "./src/assets/images/edit.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_6___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/images/github-icon.png */ "./src/assets/images/github-icon.png"), __webpack_require__.b);
...
/* harmony export */   "editTarget": () => (/* binding */ editTarget),
...
/* harmony import */ var _newProjectInput__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./newProjectInput */ "./src/modules/newProjectInput.js");
/* harmony import */ var _formEdit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./formEdit */ "./src/modules/formEdit.js");
...
function displayTasks(method, project, date) {
    ...
    _functions__WEBPACK_IMPORTED_MODULE_0__.myLibrary.forEach((task) => {
        if (task.dueDate != '') {
    ...
    function checkMethod() {
        if (myMethodToDisplay === '') {
            return myLibraryFiltered = _functions__WEBPACK_IMPORTED_MODULE_0__.myLibrary

        } else if (myMethodToDisplay === 'project') {
            return myLibraryFiltered = _functions__WEBPACK_IMPORTED_MODULE_0__.myLibrary.filter((task) => task.project === myProjectToDisplay
            )
        } else if (myMethodToDisplay === 'date') {
            if (myDateToDisplay === 'today') {
                return myLibraryFiltered = _functions__WEBPACK_IMPORTED_MODULE_0__.myLibrary.filter((task) => ((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(task.dueDate)))
            } else if (myDateToDisplay === 'thisWeek') {
                return myLibraryFiltered = _functions__WEBPACK_IMPORTED_MODULE_0__.myLibrary.filter((task) => ((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(task.dueDate, new Date())))
            }
        }
    }
    ...
    myLibraryFiltered.forEach((task) => {
        ...
        taskDiv.setAttribute('id', _functions__WEBPACK_IMPORTED_MODULE_0__.myLibrary.indexOf(task))
        ...
        if (task.dueDate != '') {
            let dateToDisplay = _functions__WEBPACK_IMPORTED_MODULE_0__.myLibrary[_functions__WEBPACK_IMPORTED_MODULE_0__.myLibrary.indexOf(task)].getDateFormatted()
        ...
        taskStatusBtn.setAttribute('id', _functions__WEBPACK_IMPORTED_MODULE_0__.myLibrary.indexOf(task))
        ...
        deleteBtn.setAttribute('id', _functions__WEBPACK_IMPORTED_MODULE_0__.myLibrary.indexOf(task))
        ...
        editBtn.setAttribute('id', _functions__WEBPACK_IMPORTED_MODULE_0__.myLibrary.indexOf(task))
...
function displayProjects() {
    ...
    //For each project :
    _functions__WEBPACK_IMPORTED_MODULE_0__.myProjects.forEach((project) => {
        ...
        projectRemoveBtn.id = _functions__WEBPACK_IMPORTED_MODULE_0__.myProjects.indexOf(project)
...
function checkcurrentProjectStatusAndDisplayTasks() {
    if (_functions__WEBPACK_IMPORTED_MODULE_0__.currentProjectStatus === false && _functions__WEBPACK_IMPORTED_MODULE_0__.currentDateStatus === false) {
        displayTasks('')
    } else if (_functions__WEBPACK_IMPORTED_MODULE_0__.currentProjectStatus === true) {
        displayTasks('project', _functions__WEBPACK_IMPORTED_MODULE_0__.currentProject, '')
    } else if (_functions__WEBPACK_IMPORTED_MODULE_0__.currentDateStatus === true) {
        displayTasks('date', '', _functions__WEBPACK_IMPORTED_MODULE_0__.currentDateFilter)
    }
}
...
function deleteTasksFromProject(projectDeleted) {
    _functions__WEBPACK_IMPORTED_MODULE_0__.myLibrary.slice().reverse().forEach((task) => {
        if (task.project === projectDeleted) {
            _functions__WEBPACK_IMPORTED_MODULE_0__.myLibrary.splice([_functions__WEBPACK_IMPORTED_MODULE_0__.myLibrary.indexOf(task)], 1)
        }
    })
    ;(0,_functions__WEBPACK_IMPORTED_MODULE_0__.storeTasks)()
}
...
function eventListeners() {
    ...
    addTaskBtn.addEventListener('click', _form__WEBPACK_IMPORTED_MODULE_1__.createForm)

    // Adding new task
    mainContent.addEventListener('click', (e) => {
        if (e.target.classList.contains('submit--button')) {
            (0,_functions__WEBPACK_IMPORTED_MODULE_0__.addTaskViaForm)()
            ;(0,_form__WEBPACK_IMPORTED_MODULE_1__.deleteForm)()
    ...
    mainContent.addEventListener('click', (e) => {
        if (e.target.classList.contains('checkbox')) {
            _functions__WEBPACK_IMPORTED_MODULE_0__.myLibrary[e.target.id].toggleStatus()
            checkcurrentProjectStatusAndDisplayTasks()
            ;(0,_functions__WEBPACK_IMPORTED_MODULE_0__.storeTasks)()
        }
    })
    ...
    mainContent.addEventListener('click', (e) => {
        if (e.target.classList.contains('delete--button')) {
            _functions__WEBPACK_IMPORTED_MODULE_0__.myLibrary.splice(e.target.id, 1)
            checkcurrentProjectStatusAndDisplayTasks()
            ;(0,_functions__WEBPACK_IMPORTED_MODULE_0__.storeTasks)()
        }
    })
    ...
    mainContent.addEventListener('click', (e) => {
        if (e.target.classList.contains('edit--button')) {
            setEditTarget(_functions__WEBPACK_IMPORTED_MODULE_0__.myLibrary[e.target.id])
            ;(0,_formEdit__WEBPACK_IMPORTED_MODULE_3__.createEditForm)(_functions__WEBPACK_IMPORTED_MODULE_0__.myLibrary[e.target.id])
        }
    })
    ...
    mainContent.addEventListener('click', (e) => {
        if (e.target.classList.contains('submit--edit--button')) {
            (0,_functions__WEBPACK_IMPORTED_MODULE_0__.editTaskViaForm)(editTarget)
            ;(0,_formEdit__WEBPACK_IMPORTED_MODULE_3__.deleteEditForm)()
            checkcurrentProjectStatusAndDisplayTasks()
        }
    })
    ...
    sideBar.addEventListener('click', (e) => {
        if (e.target.classList.contains('new--project--button')) {
            (0,_newProjectInput__WEBPACK_IMPORTED_MODULE_2__.createProjectInput)()
        }
    })
    ...
    sideBar.addEventListener('click', (e) => {
        if (e.target.classList.contains('project--validate--btn')) {
            (0,_functions__WEBPACK_IMPORTED_MODULE_0__.addNewProject)()
            ;(0,_newProjectInput__WEBPACK_IMPORTED_MODULE_2__.deleteProjectInput)()
            displayProjects()
            ;(0,_functions__WEBPACK_IMPORTED_MODULE_0__.setcurrentDateStatusFalse)()
            ;(0,_functions__WEBPACK_IMPORTED_MODULE_0__.setcurrentProjectStatusTrue)()
            checkcurrentProjectStatusAndDisplayTasks()
        }
    })
    ...
    sideBar.addEventListener('click', (e) => {
        if (e.target.classList.contains('project--list-btn')) {
            (0,_functions__WEBPACK_IMPORTED_MODULE_0__.setcurrentDateStatusFalse)()
            ;(0,_functions__WEBPACK_IMPORTED_MODULE_0__.setcurrentProjectStatusTrue)()
            ;(0,_functions__WEBPACK_IMPORTED_MODULE_0__.setCurrentProject)(e.target.id)
            displayTasks('project', _functions__WEBPACK_IMPORTED_MODULE_0__.currentProject)
        }
    })
    ...
    sideBar.addEventListener('click', (e) => {
        if (e.target.classList.contains('project--remove--btn')) {
            setProjectToDelete(_functions__WEBPACK_IMPORTED_MODULE_0__.myProjects[e.target.id].name)
            console.log(myProjectToDelete)
            _functions__WEBPACK_IMPORTED_MODULE_0__.myProjects.splice(e.target.id, 1)
            deleteTasksFromProject(myProjectToDelete)
            checkcurrentProjectStatusAndDisplayTasks()
            displayProjects()
            ;(0,_functions__WEBPACK_IMPORTED_MODULE_0__.storeProjects)()
        }
    })
    ...
    sideBar.addEventListener('click', (e) => {
        if (e.target.id === 'inbox') {
            (0,_functions__WEBPACK_IMPORTED_MODULE_0__.setcurrentProjectStatusFalse)()
            ;(0,_functions__WEBPACK_IMPORTED_MODULE_0__.setcurrentDateStatusFalse)()
            displayTasks('')
        }
    })
    ...
    sideBar.addEventListener('click', (e) => {
        if (e.target.id === 'today') {
            (0,_functions__WEBPACK_IMPORTED_MODULE_0__.setcurrentDateStatusTrue)()
            ;(0,_functions__WEBPACK_IMPORTED_MODULE_0__.setcurrentProjectStatusFalse)()
            ;(0,_functions__WEBPACK_IMPORTED_MODULE_0__.setCurrentDateFilter)(e.target.id)
            displayTasks('date', '', _functions__WEBPACK_IMPORTED_MODULE_0__.currentDateFilter)
        }
    })
    ...
    sideBar.addEventListener('click', (e) => {
        if (e.target.id === 'this--week') {
            (0,_functions__WEBPACK_IMPORTED_MODULE_0__.setcurrentDateStatusTrue)()
            ;(0,_functions__WEBPACK_IMPORTED_MODULE_0__.setcurrentProjectStatusFalse)()
            ;(0,_functions__WEBPACK_IMPORTED_MODULE_0__.setCurrentDateFilter)('thisWeek')
            displayTasks('date', '', _functions__WEBPACK_IMPORTED_MODULE_0__.currentDateFilter)
        }
    })
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "mainAppFunction": () => (/* binding */ mainAppFunction)
/* harmony export */ });
/* harmony import */ var _launchApp__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./launchApp */ "./src/modules/launchApp.js");
/* harmony import */ var _DOMevents__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DOMevents */ "./src/modules/DOMevents.js");
/* harmony import */ var _functions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./functions */ "./src/modules/functions.js");




const mainAppFunction = function () {
    ...
    ;(0,_launchApp__WEBPACK_IMPORTED_MODULE_0__.launchApp)()
    ;(0,_functions__WEBPACK_IMPORTED_MODULE_2__.restoreTasks)()
    ;(0,_functions__WEBPACK_IMPORTED_MODULE_2__.restoreProjects)()
    ;(0,_DOMevents__WEBPACK_IMPORTED_MODULE_1__.displayTasks)('')
    ;(0,_DOMevents__WEBPACK_IMPORTED_MODULE_1__.displayProjects)()
    ;(0,_DOMevents__WEBPACK_IMPORTED_MODULE_1__.eventListeners)()
}
...
class ProjectInput {
    ...
    setInput() {
        ...
        let projectInputs = _functions__WEBPACK_IMPORTED_MODULE_0__.myProjects
...
/* harmony export */   "deleteEditForm": () => (/* binding */ deleteEditForm)
/* harmony export */ });
/* harmony import */ var _functions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./functions */ "./src/modules/functions.js");
/* harmony import */ var _DOMevents__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DOMevents */ "./src/modules/DOMevents.js");
...
class TextInput {
    ...
    setInput() {
        ...
        input.required = true
        input.maxLength = 16
        input.value = _DOMevents__WEBPACK_IMPORTED_MODULE_1__.editTarget.title
        return input
    }
}
...
class DescriptionInput {
    ...
    setInput() {
        ...
        input.maxLength = 50
        input.required = true
        input.value = _DOMevents__WEBPACK_IMPORTED_MODULE_1__.editTarget.description
        return input
    }
}
...
class DueDateInput {
    ...
    setInput() {
        ...
        input.id = this.description
        input.required = false
        input.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(_DOMevents__WEBPACK_IMPORTED_MODULE_1__.editTarget.dueDate)
        return input
    }
}
        ...
        projectPriorityInputs.forEach((priority) => {
            ...
            function setSelectedIndex() {
                for (var i = 0; i < projectPriorityInputs.length; i++) {
                    if (_DOMevents__WEBPACK_IMPORTED_MODULE_1__.editTarget.priority === projectInput.innerText) {
        ...
        projectInputs.forEach(project => {
            ...
            function setSelectedIndex() {
                for (var i = 0; i < projectInputs.length; i++) {
                    if (_DOMevents__WEBPACK_IMPORTED_MODULE_1__.editTarget.project === projectSelection.innerText) {
...
/* harmony export */   "addTaskToLibrary": () => (/* binding */ addTaskToLibrary),
/* harmony export */   "addTaskViaForm": () => (/* binding */ addTaskViaForm),
/* harmony export */   "currentDateFilter": () => (/* binding */ currentDateFilter),
/* harmony export */   "currentDateStatus": () => (/* binding */ currentDateStatus),
/* harmony export */   "currentProject": () => (/* binding */ currentProject),
/* harmony export */   "currentProjectStatus": () => (/* binding */ currentProjectStatus),
/* harmony export */   "editTaskViaForm": () => (/* binding */ editTaskViaForm),
/* harmony export */   "filterTasksByProject": () => (/* binding */ filterTasksByProject),
/* harmony export */   "myLibrary": () => (/* binding */ myLibrary),
/* harmony export */   "myProjects": () => (/* binding */ myProjects),
/* harmony export */   "restoreProjects": () => (/* binding */ restoreProjects),
/* harmony export */   "restoreTasks": () => (/* binding */ restoreTasks),
/* harmony export */   "setCurrentDateFilter": () => (/* binding */ setCurrentDateFilter),
/* harmony export */   "setCurrentProject": () => (/* binding */ setCurrentProject),
/* harmony export */   "setcurrentDateStatusFalse": () => (/* binding */ setcurrentDateStatusFalse),
/* harmony export */   "setcurrentDateStatusTrue": () => (/* binding */ setcurrentDateStatusTrue),
/* harmony export */   "setcurrentProjectStatusFalse": () => (/* binding */ setcurrentProjectStatusFalse),
/* harmony export */   "setcurrentProjectStatusTrue": () => (/* binding */ setcurrentProjectStatusTrue),
/* harmony export */   "storeProjects": () => (/* binding */ storeProjects),
/* harmony export */   "storeTasks": () => (/* binding */ storeTasks)
/* harmony export */ });
/* harmony import */ var _tasksCreation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tasksCreation */ "./src/modules/tasksCreation.js");
...
function addNewProject(name, tasks) {
    ...
    let newProject = (0,_projects__WEBPACK_IMPORTED_MODULE_1__.Projects)(
        inputName.value,
        tasks)
    if (inputName.value === '') {
...
function addDefaultProject(name, tasks) {
    let newProject = (0,_projects__WEBPACK_IMPORTED_MODULE_1__.Projects)(name, tasks)
    myProjects.push(newProject)
    storeProjects()
}
...
function addTaskToLibrary(title, description, dueDate, priority, project, status) {
    let newTask = (0,_tasksCreation__WEBPACK_IMPORTED_MODULE_0__.Tasks)(title, description, dueDate, priority, project, status);
...
function addTaskViaForm(title, description, dueDate, priority, project, status) {
    ...
    let newTask = (0,_tasksCreation__WEBPACK_IMPORTED_MODULE_0__.Tasks)(
        inputTitle.value,
...
/***/ "./src/modules/newProjectInput.js":
/*!****************************************!*\
  !*** ./src/modules/newProjectInput.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "deleteProjectInput": () => (/* binding */ deleteProjectInput)
/* harmony export */ });
/* harmony import */ var _functions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./functions */ "./src/modules/functions.js");
...
const Tasks = (title, description, dueDate, priority,project, status = 'false') => {
  ...
  return {
    ...
    getDateFormatted(newDate) {
        if (this.dueDate === '') {
            return newDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"]) (new Date(), 'dd/MM/yyy')
        } else {
        return newDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(this.dueDate), 'dd/MM/yyyy')
    }
    },

    setDueDate (newDate) {
        this.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(newDate))
    },
...
module.exports = __webpack_require__.p + "images/0f46e2728eb984e21ce8.png";
...
module.exports = __webpack_require__.p + "images/1c2963ee3467352a1681.png";
...
module.exports = __webpack_require__.p + "images/c4e35861d2606e76ed78.png";
...
module.exports = __webpack_require__.p + "fonts/c0d735fc04154e03a691.ttf";

/***/ }),

/***/ "./src/assets/fonts/San Francisco Bold.ttf":
/*!*************************************************!*\
  !*** ./src/assets/fonts/San Francisco Bold.ttf ***!
  \*************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "fonts/b68d4b81282342ec9f9e.ttf";

/***/ }),

/***/ "./src/assets/fonts/San Francisco Regular.ttf":
/*!****************************************************!*\
  !*** ./src/assets/fonts/San Francisco Regular.ttf ***!
  \****************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "fonts/cb07a66458c9311b6721.ttf";
...
/* harmony import */ var _modules_appRecap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/appRecap */ "./src/modules/appRecap");



(0,_modules_appRecap__WEBPACK_IMPORTED_MODULE_1__.mainAppFunction)()
